...
<div class="login-box">
    <div class="login-logo">
        <p><img src="logo.png" class="rounded-circle" alt="logo" width="50%"></p>
        <a href="#" class="text-white"><b class="text-uppercase" style="font-size: 27px"><?php echo $_SESSION['system']['name'] ?> Nhóm 12</b></a>
    </div>
  <!-- /.login-logo -->
  <div class="card">
