...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control form-control-sm" id="name" name="name" value="<?php echo isset($name) ? $name : '' ?>" required>
				</div>
			</div>
          	<div class="col-md-6">
				<div class="form-group">
					...
					<select name="status" id="status" class="custom-select custom-select-sm" required>
						<option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>Đang chờ</option>
		...
		<div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Ngày hoàn thành</label>
        ...
        <div class="row">
           ...
           <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="form-control form-control-sm select2" name="manager_id" id="manager_id" required>
              	<option></option>
              	<?php 
      ...
      <?php else: ?>
      	<input type="hidden" name="manager_id" id="manager_id" value="<?php echo $_SESSION['login_id'] ?>">
      <?php endif; ?>
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Thành viên tham gia dự án</label>
              <select class="form-control form-control-sm select2" multiple="multiple" name="user_ids[]" id="user_ids" required>
              	<option></option>
              	<?php 
	...
	$('#manage-project').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					alert_toast('Đã lưu thành công',"success");
                    $.ajax({
                        url:'ajax.php?action=new_notification',
                        dataType: 'text',
                        data: {
                            id: "",
                            project_id: "",
...
<!--    $(function() {-->
<!--        $( "input[type=date]" ).datepicker( $.datepicker.regional[ "vi" ] );-->
<!--    });-->
<!--</script>-->